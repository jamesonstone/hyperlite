...
for architecture in arm64 x86_64; do
  xcrun swiftc -parse-as-library -O -target "$architecture-apple-macos13.0" -framework SwiftUI -framework AppKit -framework Carbon -framework NaturalLanguage -framework UserNotifications -lsqlite3 \
    "${swift_sources[@]}" \
