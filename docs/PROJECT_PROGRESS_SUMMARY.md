...
| 0033 | open-pr-watch-stage | `docs/specs/0033-open-pr-watch-stage` | deliver | no | 2026-09-13 | Vertical Mode Open PRs watch stage: lantern-marked clusters, two-line compact titles, leftover solar system of hidden projects. |
...
- 2026-09-13: Added feature `0033-open-pr-watch-stage` so Vertical Mode Open
  ...
  solar system of hidden idle projects sized from heavily cached commit
  counts.
